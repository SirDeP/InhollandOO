...
namespace BluetoothDbus.Bluetooth
{
    ...
    public interface IMedia1 : IDBusObject
    {
        ...
        Task UnregisterApplicationAsync(ObjectPath Application);
        Task<T> GetAsync<T>(string prop);
        Task<Media1Properties> GetAllAsync();
        Task SetAsync(string prop, object val);
        Task<IDisposable> WatchPropertiesAsync(Action<PropertyChanges> handler);
    }

    [Dictionary]
    public class Media1Properties
    {
        private string[] _SupportedUUIDs = default(string[]);
        public string[] SupportedUUIDs
        {
            get
            {
                return _SupportedUUIDs;
            }

            set
            {
                _SupportedUUIDs = (value);
            }
        }
    }

    public static class Media1Extensions
    {
        public static Task<string[]> GetSupportedUUIDsAsync(this IMedia1 o) => o.GetAsync<string[]>("SupportedUUIDs");
    }
    ...
    public interface IInput1 : IDBusObject
    {
        Task<T> GetAsync<T>(string prop);
    ...
    public static class Input1Extensions
    {
